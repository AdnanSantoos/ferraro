...
<body>
    ...
    <section class="sample-text-area">
		<div class="container box_1170">
			...
			<p class="sample-text">
				Faça sua cotação e receba os melhores preços do mercado. Contamos com diversas seguradoras e operadoras presentes em todo o país! Aproveite e faça já a sua cotação! 
            </p>
            <a href="https://ferraro.aggilizador.com.br/auto" target="_blank" class="boxed-btn3">Faça já sua cotação Auto</a>
		</div>
    </section>
 <!-- service_area_start -->
<!-- service_area_end -->
<section class="contact-section pt-0">
    <div class="container">
        <div class="row">
            <div class="col-12">
                <h2 class="contact-title">Solicite uma cotação de Seguro</h2>
            </div>
            <div class="col-lg-12">
                            ...
                            <div class="form-group">
                                <div class="input-group-icon form-control">
                                    <div class="form-select" id="default-select">
                                        ...
                                        <option value="Ramos Elementares">Ramos Elementares</option>
                                        </select>
                                    </div>
                                </div>
                            </div>
